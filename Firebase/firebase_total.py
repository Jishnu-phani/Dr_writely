...
upload_pdf_to_bucket('tejas',strx,'C:/Users/gteja/Documents/Python/Dr-Writely-Git/Dr_writely/Firebase/gg.pdf')

lines = content_output.split('\n')[-1]
lines = lines.split(':')[-1]

create_doctor_account('jayant','tejas',meds_arr,lines)
